...
*/
#ifndef _externalcommand_h
#define _externalcommand_h

#include "datatypes.h"


/// @brief Check to see if other test using the command prompt can be run
/// @return True if it exists, false otherwise.
Boole CheckForCommandInterpretter();

/// @brief Executes a command at the shell
