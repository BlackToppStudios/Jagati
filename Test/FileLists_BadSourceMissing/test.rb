...
class FileLists_BadSourceMissing < JagatiTestCase
    def test_file_lists
        cmake = run_cmake_and_load_cache :should_fail # The jagati rejects Hello2.cpp because its missing
        ...
        assert_match(/Could.*not.*find.*source.*directory/, cmake.stderr.join, "Reports missing when source missing")
