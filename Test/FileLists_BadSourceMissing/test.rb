# This is a variation on the FileLists tests that verifies a good error is generated when a Source file is missing.

class FileLists_BadSourceMissing < JagatiTestCase
    def test_file_lists
        cmake = run_cmake_no_dox_and_load_cache :should_fail # The jagati rejects Hello2.cpp because its missing
        ...
        assert_match(/Could.*not.*find.*source.*directory/m, cmake.stderr.join, "Reports missing when source missing")
