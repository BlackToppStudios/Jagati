...
class FileLists_BadDoxRoot < JagatiTestCase
    def test_file_lists
        cmake = run_cmake_no_dox_and_load_cache :should_fail # The jagati rejects HelloDoc.h because its mis-located
        ...
        assert_match(/Outside.*dox.*header.*dir/m, cmake.stderr.join, "Jagati Dox reports misplaced file")
