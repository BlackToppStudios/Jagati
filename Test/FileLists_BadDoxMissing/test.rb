...
class FileLists_BadDoxMissing < JagatiTestCase
    def test_file_lists
        cmake = run_cmake_and_load_cache :should_fail # The jagati rejects HelloDoc.h because its missing
        ...
        assert_match(/Could.*not.*find.*dox.*directory/, cmake.stderr.join, "Jagati Dox reports misplace file")
